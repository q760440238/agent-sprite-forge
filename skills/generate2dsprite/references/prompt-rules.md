...
- background is fully transparent (PNG alpha channel)
...
- Keep the normal transparent-background and containment rules even when using a reference.
...
- leave transparent margin on all four sides
...
6. restate transparent background and no-text rules
